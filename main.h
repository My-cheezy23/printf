...
/* Function to print non printable characyers */
int print_non_printable_list(va_list types, char buffer[],
int flags, int width, int precision, int size);
...
int write_pointers(char buffer[], int ind, int length,int
width, int flags, char padd, char extra_c, int padd_start;
